  ...
  const testTypes = [
    {
      ...
      icon: "bi-headphones",
      color: "#4361ee",
      link: "/practice-tests/ielts/listening"
    },
    {
      id: 2,
      title: "Reading Test",
      ...
      icon: "bi-book",
      color: "#3a0ca3",
      link: "/practice-tests/ielts/reading"
    },
    {
      id: 3,
      title: "Writing Test",
      ...
      icon: "bi-pencil",
      color: "#7209b7",
      link: "/practice-tests/ielts/writing"
    },
    {
      id: 4,
      title: "Speaking Test",
      ...
      icon: "bi-mic",
      color: "#f72585",
      link: "/practice-tests/ielts/speaking"
    }
  ];

  // Language options for All Tests
  const languages = [
    {
      id: 1,
      name: "IELTS",
  ...
  return (
    ...
    <div className="practice-tests-container animate-fade-in" style={{ marginTop: "80px" }}>
      ...
      <div className="container mt-5 mb-5">
        <h2 className="text-center mb-4" style={{color:'#111', fontWeight:700}}>Choose a Practice Test Language</h2>
        <div className="row justify-content-center mb-3">
          {languages.map((lang) => (
            ...
            >
              ...
              >
                <div className="language-icon bg-primary text-white rounded-circle d-flex align-items-center justify-content-center mb-3 mx-auto" style={{width:60,height:60}}>
                  <i className={`bi ${lang.icon} fs-2`} />
                </div>
